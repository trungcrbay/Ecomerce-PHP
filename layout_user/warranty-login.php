...
<body>
    <main>
        ...
        <div class="d-block mx-auto" style="width:80vw;padding-top:100px;">
            <h2 style="margin-right:40%;">Chính sách bảo hành</h2>
            ...
            <p>Khách hàng có thể bảo hành máy tại các cửa hàng Tech Shop trên toàn quốc cũng như trung tâm bảo hành chính
                hãng sản phẩm</p>
            <div style="display:flex;flex-wrap:wrap;gap:20px;">
                <a href="#!" style="background:#ccc; padding:25px;height:78px;width:23%;">
                    <img src="../assets/baohanh/apple.png" alt="" style="display:block;margin:0 auto;">
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                    <img src="../assets/baohanh/samsung.png" alt="">
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                    <img src="../assets/baohanh/dell.png" alt="" style="display:block;margin:0 auto;">
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                    <img src="../assets/baohanh/asus.png" alt="" style="display:block;margin:0 auto;"
                        >
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                <img src="../assets/baohanh/hp.png" alt="" style="display:block;margin:0 auto;"
                    >
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                <img src="../assets/baohanh/oppo.png" alt="" 
                    >
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                <img src="../assets/baohanh/acer.png" alt="" style="display:block;margin:0 auto;"
                    >
                </a>
                <a href="#!" style="background:#ccc; padding:25px;height:78px; width:23%;">
                <img src="../assets/baohanh/lenovo.png" alt="" style="display:block;margin:0 auto;"
                    >
                </a>
            </div>
            <p>Thời gian tiếp nhận bảo hành sản phẩm từ 8h30 tới 12h00 và từ 13h30 tới 17h30 tất cả các ngày trong tuần (Trừ ngày nghỉ Tết Nguyên Đán).</p>
